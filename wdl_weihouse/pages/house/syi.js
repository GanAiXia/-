...
Page({
    ...
    search_params: function() {
        var i = this;
        i.data.zhutype, i.data.rent_type;
        app.util.request({
    ...
    onLoad: function(e) {
        ...
        app.kbtools.isnull(e.rent) || (s = e.rent), a = "生意转让", this.setData({
            rent_type: s,
            pagetitle: a
